    ...
    return (
        <div>
            ...
            >
                ...
                <p>
                    I quickly looked to the local community college (Northwest Arkansas Community College), but then life quickly shifted and I had a family to support; which required me to be able to support my beautiful wife and soon to be son.
                </p>
                <p>
                    I performed some local labor jobs (mover, landscaper, etc.) and then I landed in a position as a car detailer at a new car lot, and this would start leading back down the path back to where I started. I made friends with lots of the salesmen there at the lot and started coming to the realization that they always seemed to be having fun working with people. I figured, hey, this sounds like a good thing to get into, and I'm in good with the bosses, so maybe I can get into a sales position.
                </p>
                <p>
